...
public class Register extends AppCompatActivity {
    ...
    private EditText etMatatuName,etSaccoName, etRegNo, etEmail, etPassword;
...
//        Declaring views
        ...
        etMatatuName = findViewById(R.id.editTextMatatuName);
        etSaccoName = findViewById(R.id.editTextSaccoName);
...
//
    ...
    public void RegisterUser(){
        ...
        String matatuname = etMatatuName.getText().toString().trim();
        String matatuName = etSaccoName.getText().toString().trim();
                ...
                .addOnCompleteListener(Register.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            user.put("full_name", matatuname);
                            user.put("matatuName", matatuName );
                            user.put("regno", regno);
                            user.put("email", email);
                            user.put("userId", userId);
                            user.put("usertype", "operator" );
